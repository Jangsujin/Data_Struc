...
public class Simulation {
	ExponentialRandom rand = new ExponentialRandom(2); // 지수분포를 평균 2로 하여 객체를 생성
	SLinkedQueue queue1 = new SLinkedQueue(); // queue1을 만듦
	SLinkedQueue queue2 = new SLinkedQueue(); // queue2를 만듦
